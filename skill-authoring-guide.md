...
The SKILL.md body should define the opening conversational flow: what the skill says first, what inputs it asks for, and how it sets expectations. This is how the skill greets the user when it starts. See the [yaml reference](skills/write-skill/references/skillshelf-yaml-reference.md) for `skillshelf.yaml` field details.
